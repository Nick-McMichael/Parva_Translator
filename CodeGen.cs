...
namespace Parva {
  ...
  class CodeGen {
    ...
    public static void StartForLoop(bool up, Label destination) {
    ...
    public static void EndForLoop(bool up, Label destination) {
    ...
    public static void ChangeCase(bool toUpper) {
      Emit(toUpper ? PVM.cap : PVM.low);
    } // CodeGen.ChangeCase
